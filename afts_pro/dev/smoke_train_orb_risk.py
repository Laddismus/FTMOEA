...
PROFILE_NAME = "orb_eurusd_riskagent_v1"
PROFILES_PATH = Path("configs/train_profiles.yaml")
SMOKE_OUTPUT_ROOT = Path("models/dev_smoke_train/risk")
...
def main() -> None:
    ...
    logging.info("[SMOKE-TRAIN] Starting risk smoke run | profile=%s | out=%s", PROFILE_NAME, out_dir)
